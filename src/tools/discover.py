...
from src.use_cases.discover import (
    create_db_engine,
    create_glossary,
...
# TODO: Why do you have separate DISCOVER_OUTPUT_DIR and DISCOVER_AI_OUTPUT_DIR
...
def discover_database_and_generate_glossary(
    ...
    try:
        ...
        output_csv_path = os.path.join(
            settings.DISCOVER_AI_OUTPUT_DIR, output_csv_filename
        )
...
def generate_databricks_glossary_for_schemas(
    ...
    try:
        ...
        temp_glossary_path = os.path.join(
            settings.DISCOVER_AI_OUTPUT_DIR, "temp_glossary_for_update.csv"
        )
...
def update_unity_catalog(
    ...
    try:
        ...
        # TODO: Discrepancy found here: difference between apply_comments_to_unity_catalog and update_unity
...
def generate_purview_glossary_for_tables(
    ...
    try:
        ...
        temp_glossary_path = os.path.join(
            settings.DISCOVER_AI_OUTPUT_DIR, "temp_purview_glossary_for_update.csv"
        )
        df_glossary.to_csv(temp_glossary_path, index=False, encoding="utf-8")
